...
def test_magnetic_moment():
    planet=Planet('Jupiter',1.8986e27,71492e3,5.2*149597870700,1.,1.77e-4)
    star=Star('Sun', 1.989e30,6.96342e8,4.6e9,1.,1.,3.826e26)
    ...
    planet.tidal_locking(t=star.age, Ms=star.age)
    ...
    with pytest.raises(ValueError): 
        m_mag.magnetic_moment(dynamo=dynamo, planet=planet, star=star, Mmean=True, Mmax=True)
